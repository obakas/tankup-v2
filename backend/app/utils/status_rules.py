...
TANKER_STATUS_TRANSITIONS = {
    "available": {"assigned"},
    "assigned": {"queued", "available"},
    "queued": {"loading", "available"},
...
BATCH_STATUS_TRANSITIONS = {
    ...
    "assigned": {"queued", "ready_for_assignment", "assignment_failed", "expired"},
    "queued": {"loading", "ready_for_assignment", "assignment_failed", "expired"},
    "loading": {"delivering", "ready_for_assignment", "assignment_failed", "expired"},
    "delivering": {"arrived", "partially_completed", "failed", "expired"},
...
REQUEST_STATUS_TRANSITIONS = {
    ...
    "assigned": {"queued", "assignment_failed", "cancelled"},
    "queued": {"loading", "assignment_failed", "cancelled"},
    "loading": {"delivering", "assignment_failed", "cancelled"},
    "delivering": {"arrived", "completed", "partially_completed", "failed", "cancelled"},
    "arrived": {"completed", "partially_completed", "failed", "cancelled"},
    "completed": set(),
    "partially_completed": set(),
    "failed": set(),
